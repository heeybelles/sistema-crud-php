...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query->execute([$titulo, $descricao, $preco, $foto, $id]);
...
<main class="container">
    ...
    <form method="post" enctype="multipart/form-data" class="form-box">
        ...
        <textarea name="descricao" rows="4" cols="50" required><?= htmlspecialchars($produto['descricao']) ?></textarea>

        <label>Foto:</label>
        <div class="foto-preview">
            <img src="<?= !empty($produto['foto']) ? htmlspecialchars($produto['foto']) : 'https://static.vecteezy.com/system/resources/previews/010/151/956/non_2x/add-product-icon-vector.jpg' ?>" 
                 alt="Foto atual">
